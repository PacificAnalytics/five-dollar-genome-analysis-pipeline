...
task CreateIntervalSubsetList {
  ...
  command <<<
    ...
    # CLI arguments
    master_list_file = ${exome_interval_list}
    desired_N = ${scatter_number}
    wiggle_factor = 4
  ...
  output {
    Array[File] scattered_interval_list = glob("./output_intervals/*/scattered.interval_list")
    }
}
